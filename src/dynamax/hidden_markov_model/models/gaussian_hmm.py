...
import optax
from src.dynamax.parameters import ParameterProperties
from src.dynamax.hidden_markov_model.models.abstractions import HMM, HMMEmissions, HMMParameterSet, HMMPropertySet
from src.dynamax.hidden_markov_model.models.initial import StandardHMMInitialState, ParamsStandardHMMInitialState
from src.dynamax.hidden_markov_model.models.transitions import StandardHMMTransitions, ParamsStandardHMMTransitions
from src.dynamax.types import Scalar
from src.dynamax.utils.distributions import InverseWishart
from src.dynamax.utils.distributions import NormalInverseGamma
from src.dynamax.utils.distributions import NormalInverseWishart
from src.dynamax.utils.distributions import nig_posterior_update
from src.dynamax.utils.distributions import niw_posterior_update
from src.dynamax.utils.bijectors import RealToPSDBijector
from src.dynamax.utils.utils import pytree_sum
...
class DiagonalGaussianHMMEmissions(HMMEmissions):
    ...
    def m_step(self, params, props, batch_stats, m_step_state):
        if props.scale_diags.trainable and props.means.trainable:
